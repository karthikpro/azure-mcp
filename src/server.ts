...
import { CallToolResult, ListResourcesResult } from '@modelcontextprotocol/sdk/types.js';
...
import { RequestContext, ToolResultPayload } from './types.js';
...
export const createMcpServer = ({
  ...
  server.registerTool(
    ...
    async (args) =>
      observeTool('get_work_item', args, logger, metrics, async (input, context) => ({
  ...
  server.registerTool(
    ...
    async (args) =>
      observeTool('get_work_items', args, logger, metrics, async (input, context) => ({
  ...
  server.registerTool(
    ...
    async (args) =>
      observeTool('query_work_items', args, logger, metrics, async (input, context) => {
  ...
  server.registerTool(
    ...
    async (args) =>
      observeTool('list_work_items', args, logger, metrics, async (input, context) => {
  ...
  server.registerTool(
    ...
    async (args) =>
      observeTool('create_work_item', args, logger, metrics, async (input, context) => ({
  ...
  server.registerTool(
    ...
    async (args) =>
      observeTool('update_work_item', args, logger, metrics, async (input, context) => ({
  ...
  server.registerTool(
    ...
    async (args) =>
      observeTool(
        ...
        metrics,
        async (input, context) =>
          workItemService.bulkUpdateWorkItems(context, {
  ...
  server.registerTool(
    ...
    async (args) =>
      observeTool('delete_work_item', args, logger, metrics, async (input, context) => {
        if (!input.confirm) {
          throw new Error('Delete requires confirm: true.');
        }

        return {
          result: await workItemService.deleteWorkItem(
            context,
            compactObject({
  ...
  server.registerTool(
    ...
    async (args) =>
      observeTool('get_comments', args, logger, metrics, async (input, context) => ({
  ...
  server.registerTool(
    ...
    async (args) =>
      observeTool('add_comment', args, logger, metrics, async (input, context) => ({
  ...
  server.registerTool(
    ...
    async (args) =>
      observeTool('get_relations', args, logger, metrics, async (input, context) => ({
  ...
  server.registerTool(
    ...
    async (args) =>
      observeTool('add_relation', args, logger, metrics, async (input, context) => ({
  ...
  server.registerTool(
    ...
    async (args) =>
      observeTool('remove_relation', args, logger, metrics, async (input, context) => ({
  ...
  server.registerTool(
    ...
    async (args) =>
      observeTool('list_projects', args, logger, metrics, async (input, context) => ({
  ...
  server.registerTool(
    ...
    async (args) =>
      observeTool('list_work_item_types', args, logger, metrics, async (input, context) => ({
  ...
  server.registerTool(
    ...
    async (args) =>
      observeTool('list_iterations', args, logger, metrics, async (input, context) => ({
  ...
  server.registerTool(
    ...
    async (args) =>
      observeTool('list_area_paths', args, logger, metrics, async (input, context) => ({
  ...
  const workItemTemplate = new ResourceTemplate(
  ...
  server.registerResource(
    ...
    async (uri, variables) => {
      const organization =
        typeof variables.organization === 'string' ? variables.organization : undefined;
      ...
      const item = await workItemService.getWorkItem(
        { traceId, toolName: 'resource:azure-devops-work-item' },
        compactObject({ organization, project, id }),
      );
